...
val md_theme_light_primary = Color(0xFF1976EB)  // New primary color
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFD3E3FF)
val md_theme_light_onPrimaryContainer = Color(0xFF001C3B)
val md_theme_light_secondary = Color(0xFF556574)  // Adjusted to complement primary
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFD9E3F8)
val md_theme_light_onSecondaryContainer = Color(0xFF111D2C)
val md_theme_light_tertiary = Color(0xFF6D5798)  // Complementary accent
val md_theme_light_onTertiary = Color(0xFFFFFFFF)
val md_theme_light_tertiaryContainer = Color(0xFFE9DDFF)
val md_theme_light_onTertiaryContainer = Color(0xFF251344)
...
val md_theme_light_surfaceTint = Color(0xFF1976EB)
val md_theme_light_outlineVariant = Color(0xFFC4C6CF)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFFA7C8FF)  // Lighter variant for dark theme
val md_theme_dark_onPrimary = Color(0xFF003061)
val md_theme_dark_primaryContainer = Color(0xFF004B8B)
val md_theme_dark_onPrimaryContainer = Color(0xFFD3E3FF)
val md_theme_dark_secondary = Color(0xFFBDC7DC)  // Adjusted for dark mode
...
val md_theme_dark_tertiary = Color(0xFFD1BCFF)  // Dark mode complement
val md_theme_dark_onTertiary = Color(0xFF3B2867)
val md_theme_dark_tertiaryContainer = Color(0xFF533F7F)
...
val md_theme_dark_inversePrimary = Color(0xFF1976EB)
